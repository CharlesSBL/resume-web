      ...
      <div className="mx-auto max-w-4xl space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Multidisciplinary developer with a passion for technology and problem-solving
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-[2fr_1fr]">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-teal-600 dark:text-teal-400">Professional Summary</h2>
            <p className="text-muted-foreground leading-relaxed">
              I'm a multidisciplinary developer with 4+ years of hands-on experience in software development, data
              engineering, and frontend technologies. I have a strong foundation in backend systems, ETL pipelines,
              containerization, and modern frontend frameworks.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              I'm passionate about Rust, Linux, systems programming, and open source. My background also includes music
              production and sound engineering, alongside leadership roles in healthcare management and nonprofit
              operations.
            </p>
        ...
        <div className="hero-pattern rounded-xl p-8 relative">
          <div className="content-above-pattern space-y-6">
            <h2 className="text-2xl font-bold text-teal-600 dark:text-teal-400">Professional Journey</h2>
            <div className="space-y-8">
              ...
              <div className="relative border-l border-teal-500 pl-8 pb-8">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <h3 className="text-xl font-semibold">ETL & Data Engineering Intern</h3>
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-muted-foreground">BelBiGroup, Belarus</span>
              ...
              <div className="relative border-l border-teal-500 pl-8 pb-8">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <h3 className="text-xl font-semibold">Java Backend Intern</h3>
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-muted-foreground">itoverflow, Belarus</span>
              ...
              <div className="relative border-l border-teal-500 pl-8">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <h3 className="text-xl font-semibold">HR Specialist & Manager</h3>
                    <div className="flex items-center gap-2">
        ...
        <div className="pixel-village rounded-xl p-8 relative">
          <div className="content-above-pattern space-y-6">
            <h2 className="text-2xl font-bold text-teal-600 dark:text-teal-400">Education</h2>
            <div className="space-y-8">
              <div className="relative border-l border-teal-500 pl-8 pb-8">
                <div className="absolute left-0 top-0 flex h-6 w-6 items-center justify-center rounded-full border border-teal-500 bg-background">
                  <div className="h-2 w-2 rounded-full bg-teal-500"></div>
              ...
              <div className="relative border-l border-teal-500 pl-8">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <h3 className="text-xl font-semibold">Music Production & Sound Engineering Studies</h3>
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-muted-foreground">Private Courses & Self-Study</span>
        ...
        <div className="night-cottage rounded-xl p-8 relative">
          <div className="content-above-pattern space-y-6">
            <h2 className="text-2xl font-bold text-teal-600 dark:text-teal-400">Interests & Hobbies</h2>
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-lg border bg-background p-6 shadow-md card-hover-effect">
                <h3 className="text-xl font-semibold mb-4 text-teal-600 dark:text-teal-400">Technology</h3>
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  <li>Linux customization, window managers, and system internals</li>
              ...
              <div className="rounded-lg border bg-background p-6 shadow-md card-hover-effect">
                <h3 className="text-xl font-semibold mb-4 text-teal-600 dark:text-teal-400">Music</h3>
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
        ...
        {/* Languages */}
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-teal-600 dark:text-teal-400">Languages</h2>
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-lg border bg-background p-6 shadow-md card-hover-effect">
            ...
            <div className="rounded-lg border bg-background p-6 shadow-md card-hover-effect">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-teal-500 hover:bg-teal-600">Professional Working Proficiency</Badge>
              </div>
            </div>
          </div>
        </div>
